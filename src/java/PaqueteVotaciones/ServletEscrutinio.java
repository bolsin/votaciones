 ...
 * @author carlos
 */
@WebServlet(name = "ServletEscrutinio", urlPatterns = {"/ServletEscrutinio"})
public class ServletEscrutinio extends HttpServlet {

private Connection Conexion;
private ArrayList Escrutinio;
...
super.init(config);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Escrutinio = objpartido.escrutinio(Conexion);
            HttpSession session = request.getSession(true);
            request.getSession().setAttribute("tablaEscrutinio", Escrutinio);            
            response.sendRedirect("mostrarEscrutinio.jsp");
